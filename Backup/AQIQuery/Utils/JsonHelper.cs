    ...
    public sealed class JsonHelper
    {
        ...
        public static string ToJSON(object obj)
        {
            ...
            if (obj.GetType() == typeof(System.Data.DataTable))
            {
                ...
                //josnData = JsonConvert.SerializeObject(obj, Formatting.Indented, new IsoDateTimeConverter());
                //josnData = JsonConvert.SerializeObject(obj, new IsoDateTimeConverter());
                //需要返回总的记录数的话
