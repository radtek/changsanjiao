<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AirQuality.aspx.cs" Inherits="AQI_AirQuality" %>
...
<body onclick="bodyClick(event)" runat="server" style="-webkit-overflow-scrolling:touch; overflow: auto;">
