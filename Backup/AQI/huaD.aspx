<%@ Page Language="C#" AutoEventWireup="true" CodeFile="huaD.aspx.cs" Inherits="AQI_huaD" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>华东地区实时监测小时数据</title>
    ...
    <script language="javascript" type="text/javascript" src="js/huaD.js"></script>
