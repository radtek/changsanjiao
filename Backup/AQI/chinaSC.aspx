<%@ Page Language="C#" AutoEventWireup="true" CodeFile="chinaSC.aspx.cs" Inherits="AQI_chinaSC" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>全国沙尘实时监测小时数据</title>
    ...
    <script language="javascript" type="text/javascript" src="js/chinaSC.js"></script>
...
<asp:HiddenField id="Element" runat="server" />
    <div class="content">
<%--      <div style="float:right; height: 40px; width: 80px;">
        浓度单位：PM10 tsp(微克/立方米) 能见度（公里）气压（hPa）气温（℃）湿度（%）风向（°）风速（米/秒）
      </div>--%>
      <div class="querytool" style="margin-bottom: 10px">
        ...
        <%--<div id="tool_text2">到</div>
         <div  class="selectDate" style="width:150px"><input id="H01" runat="server" type="text" class="selectDateFormStyle" style="width:150px" onclick="WdatePicker({dateFmt:'yyyy年MM月dd日'})"/></div>--%>
