...
<body onclick="hide(event)" style="-webkit-overflow-scrolling:touch; overflow: auto;">
    ...
    <div id="comForecast" class="show content">
      ...
      <div  style="clear:both" ></div>
        ...
        <div class="btnarea">
               <input type="button"  id="btnSave" class="normal-btn input-btn" value="保存" onclick="doSubmit(true);Broadcast(['H09','H10','PH09']);" onmouseover="this.className='normal-btn-h input-btn'" onmouseout="this.className='normal-btn input-btn'" onmousedown="this.className='normal-btn-d input-btn'" onmouseup ="this.className='normal-btn input-btn'"/>
              <input type="button" id="btnSubmit" class="normal-btn input-btn" value="提交" onclick="createSummary(true);Broadcast(['H09','H10','PH09']);" onmouseover="this.className='normal-btn-h input-btn'" onmouseout="this.className='normal-btn input-btn'" onmousedown="this.className='normal-btn-d input-btn'" onmouseup ="this.className='normal-btn input-btn'" />
        </div>
    </div>
       ...
       <div class="tableS" style="width: 900px">
         ...
         <div id ="div1"  class="bottomDiv" style="width: 900px"> 
          <label style="margin-left: 5px">发布时间:&nbsp&nbsp<input type="text"  id="publishTime"  runat="server"  style="width: 150px" /></label>
           ...
           <label class="checkSe" style="margin-right: 10px; margin-left: 35px;"><input type="checkbox"  checked ="checked"  name="Type"  id="message"  value ="0" />移动用户</label>
           <label id="re" class="checkSe" style="margin-left: 0px; text-decoration: underline; cursor: pointer;" onclick="receivePeople('block')">接收人</label>
            <label class="checkSe" style="margin-right: 10px;"><input type="checkbox" checked ="checked"   name="Type"  id="LTDX"  value ="5" />联通电信</label>
           ...
           <label class="checkSe"><input type="checkbox" name="Type"  id="XJZX"  value ="2" />宣教中心</label>
           ...
           <label class="checkSe"><input  type="checkbox" name="Type" checked ="checked" id="txWb"  value ="6" />腾讯微博</label>
            <label class="checkSe"><input type="checkbox" name="Type"  id="ssfb"  checked ="checked" value ="3" />实时发布系统</label>
           </div>
      </div>
    </div>
