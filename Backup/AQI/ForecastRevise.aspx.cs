...
public partial class AQI_ForecastRevise : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if(int.Parse(dtNow.Hour.ToString())>15)
            ...
            foreach (DataRow row in dicDuration.Rows)
            {
                ...
                for (int j = 1; j < 3; j++)
                {
                    ...
                    int  hour = int.Parse(DateTime.Now.Hour.ToString());
                        if ((startInputIndex >= 15 && startInputIndex < 31 && (startInputIndex - 7) % 2 == 0 && j == 1 && startInputIndex % 12 != 11))
                        {
                        ...
                        {
                            if (((startInputIndex >= 7 && startInputIndex < 15 && (startInputIndex - 7) % 2 == 0 && j == 1 && startInputIndex % 12 != 11)) && hour <= 15)
                            {
                                m_Editor = false;
                                onClick = "";
                            }
                            else if (((startInputIndex >= 7 && startInputIndex < 15 && (startInputIndex - 7) % 2 == 0 && j == 1 && startInputIndex % 12 != 11)) && hour > 15)
                            {
                                m_Editor = true;
                                onClick = "onclick = 'showInput(event,this)'";
                            }
