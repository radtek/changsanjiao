<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FCSJDay.aspx.cs" Inherits="AQI_FCSJDay" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript" src="js/FCSJDay.js"></script>
