<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FCSJMonth.aspx.cs" Inherits="AQI_FCSJMonth" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript" src="js/FCSJMonth.js"></script>
    ...
    <div class="content">
      ...
      <div class="querytool" style="margin-bottom: 10px">
        <div id="tool_text">时间：</div>
         <div class="selectDate" style="width:150px"><input id="H00" runat="server" type="text" class="selectDateFormStyle" style="width:150px"   onclick="WdatePicker({dateFmt:'yyyy年MM月'})"/></div>
