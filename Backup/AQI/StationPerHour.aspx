<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StationPerHour.aspx.cs" Inherits="AQI_StationPerHour" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head  runat="server">
    <title>空气质量站点小时预报</title>
...
//        <%} %>
    ...
    <script language="javascript" type="text/javascript" src="js/StationPerHour.js"></script>
      ...
      <div class="querytool">
       ...
       <div id="tabbtn">
         <ul id="tabItem" runat="server">
            <li id="addTab" style="vertical-align:bottom;text-align:left;"><img src="images/Add_btn_g.png" style="cursor:pointer;" onmouseover="this.src='images/Add_btn_h.png'" onmouseout="this.src='images/Add_btn_g.png'" onclick="addTabClick(this);"/></li>
         </ul>
       </div>
