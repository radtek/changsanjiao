...
public partial class AQI_FCSJMonth : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        H00.Value = dtNow.ToString("yyyy年MM月");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        DateTime dtTo = DateTime.Parse(Content).AddMonths(1).AddDays(-1).AddHours(23);
