...
namespace MMShareBLL.DAL
{
    public class SiteData
    {
        ...
        public string QueryHuaD(string fromDate)
        {
            ...
            string strSQL = string.Format("SELECT  y.Timepoint,y.area,y.PositionName,y.AQI,y.PM2_5,y.PM10,y.CO,y.NO2,y.SO2,y.O31,y.O38 "+
                                          "  FROM T_Realation x left JOIN China_RT_CNEMC_Data y on " +
                                          "(x.area=y.area or x.name=y.area) where x. Flag>=1 and y.TimePoint='{0}'", dtFrom);
