<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DBCityChartPJ.aspx.cs" Inherits="DBCityChartPJ" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>东北预报准确率评估</title>
    <link href="css/DBcss.css?v=2016" rel="stylesheet" type="text/css" />
    <link type="text/css" rel="stylesheet" href="../Ext/resources/css/ext-all.css"/>
    <script type="text/javascript" src="../Ext/adapter/ext/ext-base.js"></script>
    <script type="text/javascript" src="../Ext/ext-all.js"></script>
    <script type="text/javascript" src="../Ext/ext-lang-zh_CN.js"></script>
    <script language="javascript" type="text/javascript" src="JS/DBCityChartPJ.js?v=20160812219"></script>
    ...
    <div id="contentNone">
        ...
        <div class="checkStyle" style=" width:1056px; margin-top:10px; ">
              ...
              <table align="center" cellpadding="0" cellspacing="0" class="hct">
                ...
                <tr>
                    <td>
                       <div id="container1" style="width: 1025px; height: 350px;  margin-top:-300px;"></div></td>
                </tr>
