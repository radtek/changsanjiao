...
<head runat="server">
    ...
    <link href="css/MessageManage.css?v=1208011" rel="stylesheet" type="text/css" />

    <script src="js/jquery-1.12.4.js" type="text/javascript"></script>
    <script src="js/jquery.dataTables.min.js" type="text/javascript"></script>
    <script src="js/bootstrap.min.js" type="text/javascript"></script>
    <script src="js/Utility.js?v=1219" type="text/javascript"></script>
    <script src="js/MessageManage.js?v=12291" type="text/javascript"></script>
    <title></title>
</head>
<body>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                           ...
                           <div class="form-group">
                                <label for="phoneStatus" class="col-sm-2 control-label" style="padding-right:0;">是否启用：</label>
                                <div class="col-sm-9">
