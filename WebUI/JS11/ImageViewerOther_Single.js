...
//            '<div id="mapPic"'+'style="height:'+($("#bg").height()-60)+'px"><div class="collapseCls" id="collapseCls"></div><div id="closeBtn" class="closeBtn"></div><div class="nav" id="nav">'
...
//            + '<img id="view-image"  src="' + imageSrc + '" border="0" style="cursor:url(images/pic_prev.cur),auto;height:"' + ($("#bg").height() - 120) + '  > </div>'           
    //    });

    //闫海涛修改，化学模式综合预报图添加一个按钮
    ImageViewer.superclass.constructor.call(this, {
        border: false,
        layout: "fit",
        region: "center",
...
Ext.extend(ImageViewer, Ext.Panel, {
    setImageSrc: function (imgSrc, star, end) {
        ...
        $('#view-image').bind('mousemove', function (event) {
            ...
            if ((left + viLeft - 328) <= ((width / 8) + viLeft - 328)) {
                // $('#syy').css("background-image", "url('images/nextBtnTop.png')");
                //alert("xxx");
                $('#view-image').css("cursor", "url(images/pic_prev.cur),auto");
                return;
            ...
            if ((left + viLeft - 328) > ((width / 8) + viLeft - 328) && (left + viLeft - 328) <= ((width / 8) * 7 + viLeft - 328)) {
                // $('#syy').css("background-image", "url('images/nextBtnTop.png')");
                //alert("xxx");
            ...
            if ((left + viLeft - 328) > ((width / 8) * 7 + viLeft - 328)) {
                $('#view-image').css("cursor", "url(images/pic_next.cur),auto");
                return;
            }
