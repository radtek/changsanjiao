...
public partial class AirQualityCSJ : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            //string[] layer = m_json.Split(':');
            //string strSQL = "SELECT max(ForecastDate) AS 'ForecastDate' FROM T_ModelTest WHERE Layers='" + layer[6].Replace("}","") + "'";
            //DataTable dt = db.GetDataTable(strSQL);
            this.H00.Value = DateTime.Now.ToString("yyyy-MM-dd");
            this.H00.Attributes.Add("tag", "2");
            this.H00.Attributes.Add("todayDateTime",DateTime.Now.ToString("yyyy-MM-dd"));
        }
