...
//            case "airQuality": case "xsforcast": case "guidance": case "diagnostic": case "innp": case "jgRadar": case "comForecasts": case "SuperStation": case "WeatherPollution": case "systemManage": case "dayForecast":
            case "airQuality": case "xsforcast": case "guidance": case "diagnostic":case "g20": case "innp": case "jgRadar": case "jgRadarII": case "comForecasts":case "WeatherPollution":case "DBYB":case "systemManage": case "dayForecast":
            ...
            case "webGIS":
                {
                    ...
                    if (window.location.href.indexOf("222.66.83.21") > 0) {
                        if (objWin == null || objWin.closed) {
                            addHtmlPanelWebGIS("WebGIS/WaiAQIForcastWebGIS/index.html?v=20150503");
                        ...
                        if (objWin == null || objWin.closed) {
                            addHtmlPanelWebGIS("WebGIS/AQIForcastWebGIS/index.html?v=20150503");
                            objWin = document.getElementById("gis").contentWindow;
                            objWin.type = type;
                            objWin.level = JB;
                        } else {
            ...
            case "webGIS1":
                {
                    ...
                    if (window.location.href.indexOf("222.66.83.21") > 0) {
                        ...
                        if (objWin == null || objWin.closed) {
                            addHtmlPanelWebGIS("WebGIS/AQIForcastWebGIS/index.html?v=20150403");
                            objWin = document.getElementById("gis").contentWindow;
                            objWin.type = type;
                        } else {
                            objWin.type = type;
            ...
            case "ProductHomePage":
                {
                    addHtmlPanelWebGIS("ProductHomePage.aspx?v=20150403");
                    break;
                }
...
//                break;
            ...
            //预报制作部分
            case "reprotProduce": case "SuperStation": case "EastChinaReprotProduce": case "JiangXiAQIPart":
                center.removeAll(true);
                west.removeAll(true);
                ...
                SetWestPanelHtml(action);
                west.doLayout();
                //addHtmlPanelWebGIS("http://222.66.83.21:8087/cewf/", "");
                break;
            case "ReportWorkArea":
                center.removeAll(true);
                west.removeAll(true);
            ...
            case "ForecastScore":
                ...
                west.expand(false);
                SetWestPanelHtml(action);
                addHtmlPanel("ReportProduce/ScoreScreening.aspx?v=1", "HomePage");
                west.doLayout();
                            ...
                            if (secondNodeText == "") {
                                ...
                                if (data[i].flag != null) {
                                    ...
                                    //                                    theHtml += "<div class='secondMenu' id='" + data[i].flag + "_" + data[i].ALIGN + "_" + data[i].PERIOD + "_" + data[i].AliasName + "_" + data[i].HINT + "_" + data[i].ENTITYNAME + "'><div class='leftCssClick leftCommom'></div><div class='middleCssClick middleCommom'><div class='menuarrow' ></div><label class='OnlyLable'>" + data[i].HINT + "</label></div><div class='rightCommom rightCssClick'></div></div>";
                                        ...
                                        if (node.id == "ReportWorkArea" || node.id == "ForecastScore") {
