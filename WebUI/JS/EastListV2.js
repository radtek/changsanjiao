...
function CreateHtml() {
    ...
    Ext.Ajax.request({
        url: getUrl('MMShareBLL.DAL.ForecastV2', 'GetEntityType'),
...
function trickQueryList(Datetime) {
    Ext.Ajax.request({
        //        url: getUrl('MMShareBLL.DAL.ForecastV2', 'trickQueryListII'),
        url: getUrl('MMShareBLL.DAL.ForecastV2', 'trickQueryListMM'),
...
//    imageViewer = new ImageViewer(src, id, "");
    ...
    $('#showImg').fadeIn(400);
    Ext.Ajax.request({
        url: getUrl('MMShareBLL.DAL.ForecastV2', 'CreateBottomSelectII'),
...
function QueryImg(dateTime, hour) {
    ...
    Ext.Ajax.request({
        url: getUrl('MMShareBLL.DAL.ForecastV2', 'ReduceButtonII'),
