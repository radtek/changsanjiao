...
GISToolbar = function (tempArray, loginTime, nowClickName) {
    ...
    GISToolbar.superclass.constructor.call(this, {
        ...
        id: 'gisToolbar',
        layout: 'column',
        //        html: "<div class='manage_h' style='margin-right:5px;' title='管理' onmouseover=\"this.className='manage_h'\" onmouseout=\"this.className='manage'\"></div><div class='zx' onclick='exit()' title='退出' onmouseover=\"this.className='zx_h'\" onmouseout=\"this.className='zx'\"></div><div class='OUTBack' onclick='window.location.href=\"default2.aspx?userName=" + loginInfo.UserName + "&loginParams=" + loginInfo.toString() + "\"'  title='返回' onmouseover=\"this.className='INBack'\" onmouseout=\"this.className='OUTBack'\"><ul></ul></div>",
