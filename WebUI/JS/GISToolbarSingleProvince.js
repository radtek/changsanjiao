...
GISToolbar = function (tempArray, loginTime, nowClickName) {
    ...
    GISToolbar.superclass.constructor.call(this, {
        ...
        html: "<div class='manage_h' style='margin-right:5px;' title='管理' onmouseover=\"this.className='manage_h'\" onmouseout=\"this.className='manage'\"></div><div class='zx' id='btnExit' title='退出' onclick='exit()' onmouseover=\"this.className='zx_h'\" onmouseout=\"this.className='zx'\"></div><div class='OUTBack' id='btnBack' title='返回' onmouseover=\"this.className='INBack'\" onmouseout=\"this.className='OUTBack'\"><ul></ul></div>",
        items: []
    });
    this.add(createTime());
