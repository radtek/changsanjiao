<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EastListTen.aspx.cs" Inherits="EastListTen" %>
...
<head runat="server">
  ...
  <link href="css/PublicAspx.css" rel="stylesheet" type="text/css" />
    ...
    <script language="javascript" type="text/javascript" src="JS/EastListTen.js"></script>
...
<body id="Body1" runat="server" style="-webkit-overflow-scrolling:touch; overflow: auto;" >
    ...
    <div id="showImg" class="hidden">
        ...
        <div class="buttonPattonWide" id="buttonPatton">
