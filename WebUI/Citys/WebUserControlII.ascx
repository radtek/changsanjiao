<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WebUserControlII.ascx.cs" Inherits="Citys_WebUserControlII" %>
...
<div id="citypicker_container" style=" display: block;"><div id="citypicker_caption"><h1>选择城市</h1><span id="clos" title="展开/折叠" >关闭</span></div>
