<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Viewing.aspx.cs" Inherits="Viewing" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../JS/Utility.js" type="text/javascript"></script>
    <script src="js/Viewing.js?V=2017090111" type="text/javascript"></script>
...
<div class="tableTop">
      <div id="topInfo" class="titleContent">
        <table style=" width:93%">
            ...
            <div id="Div53" class="button_Bottom" style="width:48px" onclick="window.open('ViewingQuery.aspx');">调取历史</div>          
            ...
            <div id="Div125" class="button_Bottom" style="width:48px" onclick='publishWB()'>微博发布</div>
            </td>
            </tr>
        </table>
      </div>
           ...
           <td class="regionOrder" style=" width:120px" rowspan='2' ><div class="areaOrder">古镇类</div></td>
               ...
               <div id="map" class="mpnew" style="float:right;  left: 0px;">
                 <div class="mapTitleNew">
                  <span>观景指数等级预报</span>
                  <span class="export" title="导出这张图片" onclick="DownloadWB()" style=" margin-right:15px"></span>
                 </div>
