<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AirCleaning.aspx.cs" Inherits="AirCleaning" %>
...
<head id="Head1" runat="server">
    ...
    <link href="css/AirCleaning.css?v=20160429" rel="stylesheet" type="text/css" />
    ...
    <script src="../JS/Utility.js" type="text/javascript"></script>
    <script src="js/AirCleaning.js?V=20160310" type="text/javascript"></script>
...
<div class="tableTop">
      <div id="topInfo" class="titleContent">
        <table style=" width:93%">
            ...
            <div id="Div51" class="button_Bottom" style="width:48px" onclick="window.open('AirCleaningQuery.aspx');">调取历史</div>            
            <div id="foreSave" class="button_Bottom">保存</div>
            <div id="Div16" class="button_Bottom" style="width:48px" onclick="publish()">发布</div>
            </td>
            </tr>
        </table>
      </div>
           ...
           <div class="tablePart">
               ...
               <div id="map" class="mpnew" style="float:right;  left: 0px;">
                 ...
                 <div class="mapDate"><span>预报时间：</span><span id="mapDate">2016年9月14日</span></div>
                       ...
                       <div id="YeSheng" style="background-size: contain; " title="上海野生动物园" data-toggle="tooltip" data-placement="top"></div>
                       <div id="ShiJi"  title="上海世纪公园" data-toggle="tooltip" data-placement="top"></div>
                       <div id="XianHua" title="上海鲜花港" data-toggle="tooltip" data-placement="top"></div>
                       <div id="JinJiang" title="锦江乐园" data-toggle="tooltip" data-placement="top"></div>
                       <div id="JinLuo" title="上海金罗店美兰湖景区" data-toggle="tooltip" data-placement="top"></div>
                       <div id="MaLu" title="上海马陆葡萄艺术村" data-toggle="tooltip" data-placement="top"></div>
                       <div id="HuanLe" title="上海欢乐谷" data-toggle="tooltip" data-placement="top"></div>
                       <div id="ChenShan" title="上海辰山植物园" data-toggle="tooltip" data-placement="top"></div>
                       <div id="FengJing" title="枫泾古镇" data-toggle="tooltip" data-placement="top"></div>
                       <div id="JinShan" title="金山城市沙滩景区" data-toggle="tooltip" data-placement="top"></div>
                       <div id="LangXia" title="廊下生态园" data-toggle="tooltip" data-placement="top"></div>
                       <div id="ZhuJia" title="朱家角古镇" data-toggle="tooltip" data-placement="top"></div>
                       <div id="DongFang" title="东方绿舟" data-toggle="tooltip" data-placement="top"></div>
                       <div id="BiHai" title="碧海金沙景区" data-toggle="tooltip" data-placement="top"></div>
                       <div id="HaiWan" title="上海海湾国家森林公园" data-toggle="tooltip" data-placement="top"></div>
                       <div id="DongPing" title="东平国家森林公园" data-toggle="tooltip" data-placement="top"></div>
                       <div id="XiSha" title="上海明珠湖·西沙湿地景区" data-toggle="tooltip" data-placement="top"></div>
