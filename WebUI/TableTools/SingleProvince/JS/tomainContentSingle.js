...
function InitialViewer(loginTime, product) {
    ...
    function SetWestPanelHtml_JX(node) {
        $.ajax({ url: getUrl('MMShareBLL.DAL.ForecastJX', 'GetLeftPanel_JXSingle'),
            type: 'get',
            cache: false,
            dataType: 'json',
            //            data: { node: node.id },
