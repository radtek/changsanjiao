                       ...
                       },
                        {
                            ...
                            handler: function () {//点击时触发的事件
                                ...
                                Ext.Ajax.request({
                                    ...
                                    params: { ftpString: ftpString, fileDate: fileDate, functionName: 'AQIPeriod48_17', txtContent: txtPubContent, txtMsg: txtMsgContent, userName: userName, dateType: generalDateType },
                                    success: function (response) {
                                        if (response.responseText != "") {
                                            if (response.responseText != "") {
                                                myMask.hide();
