...
<body style="-webkit-overflow-scrolling:touch; overflow: auto;" >
      ...
      <div id="content">
        ...
        <div id="Tb0"  >
         ...
         <div id="Tb1" class="hidden" >
              <div class="page_top">
                <div class="titleName">工作组人员分配</div>
              </div>
              <div style="float:left; margin-top: 10px; margin-bottom: 10px;">
              <div style="float: left;" id="workGroup" ></div>
             ...
             <div style="float:left; margin-bottom: 10px; margin-top: 10px;margin-left:100px">
               ...
               <br />
               <div>
              <p style="margin-top:40px; text-align:left;">组内人员</p>
              <button type="button" style=" margin-top:-15px; margin-right:30px; margin-bottom:13px; font-size:14px; float:right;"  class="normal-btn input-btnQuery" id="Button1" onclick="openUserInfo();" onmouseover="this.className='normal-btn-h input-btnQuery'" onmouseout="this.className='normal-btn input-btnQuery'" onmousedown="this.className='normal-btn-d input-btnQuery'" onmouseup="this.className='normal-btn input-btnQuery'" >
                    <span class="select-add"></span>
                    <span class="select-text">添加人员</span>
               </button></div>
 ...
 <div id="dialog-form-user" title="添加人员" style=" display:none;  height:100%;">
  <form>
    <fieldset>
       <div id="adUser" class="show editorContent" style="position: absolute; margin-top:-20px;">
    ...
    <div id="dialog-form-edit" title="编辑人员" style=" display:none;  height:100%;">
  <form>
    <fieldset>
       <div id="edUser" class="show editorContent" style="position: absolute; margin-top:-20px;">
       <table style=" width:100%; height:200px; line-height:12px;">
        <tbody>
         <tr >
            <td style=" width:120px;"><label id="lbl_u" class="useNameLabel">名称:</label></td>
            <td style=" width:220px;"> <input id="userName" style="width:180px; "  disabled="disabled" /></td>
            </tr>
             <tr>
            <td><label id="Label1" class="useNameLabel">排序：</label></td>
            <td >
                <input id="txt_order" type="text" style="width:180px; "/>
            </td>
           </tr>
           <tr>
            <td><label id="lbl_memo" class="useNameLabel">备注:</label></td>
            <td>
              <textarea name="memo" id="txt_memo" style="width:180px;height: 60px;"></textarea>
            </td>
           </tr>
            <tr>
            <td><label id="lbl_enabel" class="useNameLabel">是否禁用：</label></td>
            <td >
              <input id="cbx_enabel" type="checkbox" name="CheckBox">
            </td>
           </tr>
         </tbody>
       </table>
