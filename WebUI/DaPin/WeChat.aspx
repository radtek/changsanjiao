<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WeChat.aspx.cs" Inherits="HealthyWeather_WeChat" %>
            ...
            <div class="struct">
                ...
                <div class="date">
                    <div class="one" style="height:4vw; overflow:hidden">
                        <label>{{day.one}}</label>
                        <div v-if="val[0].one==1" :class="{grade:true,active1:true}"></div>
...
<body>
    ...
    <div id="page">
        ...
        <div style="position:fixed;top:0;left:0;">
            <div class="top">
                <span style="font-size:4.2vw;margin-left:2vw;float:left;">上海</span>
                <span style="font-size:4.2vw; float:right;margin-right:2vw;">{{date}}</span>
            </div>
            <my-component v-for="item in result" :type="item.type" :imgs="item.img" :day="day" :val="item.val"></my-component>
            <div class="struct"></div>
            <div class="bottom" style=" height:15vh;width:100%;float:left;margin-bottom:0;padding: 5vh 8vw;">
                <div class="level" style="background: rgb(57, 176, 110);">低</div>
                <div class="level" style="background: rgb(26, 161, 230);">轻微</div>
                <div class="level" style="background: rgb(254, 239, 53);">中等</div>
                <div class="level" style="background: rgb(241, 151, 37);">较高</div>
                <div class="level" style="background: rgb(252, 13, 27);">高</div>
            </div>
        </div>
    </div>
    </form>
</body>
    <script src="js/WeChat.js?v=1013" type="text/javascript"></script>
</html>
