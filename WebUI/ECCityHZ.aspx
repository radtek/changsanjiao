<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ECCityHZ.aspx.cs" Inherits="ECCityHZ" %>
...
<head runat="server">
   ...
   <script language="javascript" type="text/javascript" src="JS/ECCity_HZ.js"></script>
