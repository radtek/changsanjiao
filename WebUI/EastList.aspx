<%--<%@ page language="C#" autoeventwireup="true" inherits="EastList, App_Web_n2mbbtue" %>--%>
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EastList.aspx.cs" Inherits="EastList" %>
...
<head runat="server">
  ...
  <link href="css/PublicAspx.css?v=20" rel="stylesheet" type="text/css" />
    ...
    <script language="javascript" type="text/javascript" src="JS/EastList.js?v=2016102930"></script>
