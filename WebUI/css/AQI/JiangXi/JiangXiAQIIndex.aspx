<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JiangXiAQIIndex.aspx.cs" Inherits="AQI_JiangXi_JiangXiAQIIndex" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../JS/Utility.js" type="text/javascript"></script>
    <link href="css/JiangXiAQIIndex.css" rel="stylesheet" type="text/css" />
    <script src="JS/JiangXiAQIIndex.js" type="text/javascript"></script>
</head>
<body>
    ...
    <tr class="trimg">
    <td id="tdimg" colspan="6"><img src="../../css/images/noImg.GIF" id="hazeDropImg"/></img></td>
    </tr>
    </tbody></table></div>
