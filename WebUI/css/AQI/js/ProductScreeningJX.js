Ext.onReady(function () {
    ...
    Ext.Ajax.request({
        url: getUrl('MMShareBLL.DAL.AQIForecastJX', 'ReadStateTable'),
        ...
        $.each($(n).find(".condition"), function (j, m) {
            $(m).click(function () {
                ...
                switch (n.id) {
                    ...
                    //                        break; 
                    case "AQIImg":
                        urlName = "JiangXiAQIArea";
                        break;
                    case "AQIText":
                        urlName = "JiangXiAQIArea";
                        break;
                    case "AirPolSiteImg":
                        urlName = "JiangXiAirPollutionDropZone";
                        break;
                    case "AirPolDropImg":
                        urlName = "JiangXiAirPollutionDropZone";
                        break;
                ...
                window.location.href = "../AQI/JiangXi/" + urlName + ".aspx";
            });
        });
    });
