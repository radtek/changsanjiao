    ...
    <div class="inner_content">
        ...
        <div id="content" style="width: 100%">
            <div id="Tb0" style="width: 100%">
                ...
                <button type="button" class="normal-btn input-btnQuery" id="ExportData" onclick="addUser()"
                    onmouseover="this.className='normal-btn-h input-btnQuery'" onmouseout="this.className='normal-btn input-btnQuery'"
                    onmousedown="this.className='normal-btn-d input-btnQuery'" onmouseup="this.className='normal-btn input-btnQuery'"
                    style="margin-top: 10px; margin-bottom: 10px; font-size: 15px;">
                    <span class="select-add"></span><span class="select-text">新增</span>
                </button>
            ...
            <div id="Tb1" class="hidden">
                ...
                <div>
                    <p style="margin-top: 40px; text-align: left;">
                        组内人员</p>
                    <button type="button" style="margin-top: -62px; margin-right: 30px; margin-bottom: 13px;
                        ...
                        <span class="select-add"></span><span class="select-text">添加人员</span>
                    </button>
                </div>
            ...
            <div id="edUser" class="show editorContent" style="position: absolute; margin-top: -20px;">
                <table style="width: 100%; height: 200px; line-height: 12px;">
                    <tbody>
                        <tr>
                            <td style="width: 120px;">
                                <label id="lbl_u" class="useNameLabel">
                                    名称:</label>
                            </td>
                            <td style="width: 220px;">
                                <input id="userName" style="width: 180px;" disabled="disabled" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <label id="Label1" class="useNameLabel">
                                    排序：</label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <label id="lbl_memo" class="useNameLabel">
                                    备注:</label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <label id="lbl_enabel" class="useNameLabel">
                                    是否禁用：</label>
                            </td>
                            <td>
