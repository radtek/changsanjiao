<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IAQIChart.aspx.cs" Inherits="EvaluateHtml_IAQIChart" %>
...
<head runat="server">
 ...
 <script language="javascript" type="text/javascript" src="JS/IAQIChart.js?v=20170817"></script>
...
<%--                          <input type="button" style=" float:left;  margin-left:20px;" id="Button1" class="button" value="导出" onclick="Export()" />--%>
        </div>
    </div>
    </div>
