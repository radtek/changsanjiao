<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IcsAndStsEvaluation.aspx.cs" Inherits="EvaluateHtml_IcsAndStsEvaluation" %>
...
<script language="javascript" type="text/javascript" src="JS/ajaxfileupload.js"></script>
 ...
 <script language="javascript" type="text/javascript" src="../DatePicker/WdatePicker.js"></script>
    <script src="JS/AQIDayScore.js" type="text/javascript"></script>
  ...
  <div style=" width:80%; margin-left:auto; margin-right:auto; ">
    ...
    <div>
        <div class="checkStyle">
            ...
            <%-- <input type="button" style=" float:left;  margin-left:20px;" id="Button2" class="normal-btn input-btn" value="导入" onclick="InsertData()" onmouseover="this.className='normal-btn-h input-btn'" onmouseout="this.className='normal-btn input-btn'" onmousedown="this.className='normal-btn-d input-btn'"  onmouseup ="this.className='normal-btn input-btn'"/>
             <input type="button" style=" float:left;  margin-left:20px;" id="Button3" class="normal-btn input-btn" value="评分" onclick="Evaluate()" onmouseover="this.className='normal-btn-h input-btn'" onmouseout="this.className='normal-btn input-btn'" onmousedown="this.className='normal-btn-d input-btn'"  onmouseup ="this.className='normal-btn input-btn'"/>--%>
