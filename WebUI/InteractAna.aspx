<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InteractAna.aspx.cs" Inherits="InteractAna" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript" src="JS/toMainViewerSingle.js"></script>
    <script src="JS/InteractAna.js" type="text/javascript"></script>
    <style> 
