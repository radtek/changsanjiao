<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EastListReport.aspx.cs" Inherits="EastListReport" %>
...
<head runat="server">
  ...
  <link href="css/PublicAspx.css?v=22" rel="stylesheet" type="text/css" />
    ...
    <script language="javascript" type="text/javascript" src="JS/jquery.ua.js"></script>
     ...
     <script language="javascript" type="text/javascript" src="JS/ImageFrameOtherReport.js"></script>
    <script language="javascript" type="text/javascript" src="JS/EastListReport.js"></script>
