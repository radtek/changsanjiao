<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ColdWithCityQuery.aspx.cs" Inherits="ColdWithCityQuery" %>
...
<head id="Head1" runat="server">
    ...
    <link href="css/ColdWithCityQuery.css?v=20160114291" rel="stylesheet" type="text/css" />
    ...
    <script src="../JS/Utility.js" type="text/javascript"></script>
    <script src="js/ColdWithCityQuery.js?V=201260310" type="text/javascript"></script>
...
<div class="tableTop">
    ...
    <table style=" width:93%">
           ...
           <td>
           <input name="H00" type="text" id="H00" runat="server" class="selectDateFormStyle" onchange="DateChange(this)" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="2016-09-08"/></td>
...
<div class="outLine" >
        ...
        <div class="content" id="rightContent" style="float:left;">
           <div class="tablePart">
               <div class="editLabelET">
                ...
                <span class="partTitle">儿童感冒气象风险预报</span> 
               ...
               <div id="aqiAreaTable" class="tableContent">
                  ...
                  <td class="aqiItemTd">
                    <div  class="aqiContent"><div class="aqiInput"><textarea name="AQI"  rows="2" cols="1" id="Textarea11"  class="aqiValue" ></textarea></div>
                  </td>
                  <td class="aqiValueTd"> 
                  ...
                  <div  class="aqiContent"><div class="aqiInput"><textarea name="AQI"  rows="2" cols="1"  id="Textarea8"  class="aqiValueII" ></textarea></div></div>
                      ...
                      <div  class="editBtns">                                             
                      <div  class="button" onclick="copyFirstPol('1')" style=" display:none;">复制风险等级</div>
                      <div  class="button" onclick="TempSave('儿童感冒','dd1er')" style=" display:none;">暂存</div>
               ...
               <div id="aqiAreaTableII-ertong" class="tableContent" style=" display:none">
                  ...
                  <div  class="aqiContent"><div class="aqiInput"><textarea name="AQI"  rows="2" cols="1"  id="Textarea72"  class="aqiValueII" ></textarea></div></div>
                      ...
                      <div class="editBtns">                                             
                      <div  class="button" onclick="copyFirstPol('2')" style=" display:none;">复制风险等级</div>
                      <div  class="button" onclick="TempSave('儿童感冒','dd2er')" style=" display:none;">暂存</div>
           </div>
           </div>        
    ...
    <div class="totalContentII" >
        <div class="content" id="Div1" style="float:left;">
           <div class="tablePart">
               <div class="editLabel">
           <div class="titlePoint"></div>
           <span class="partTitle">青少年和成年人感冒风险预报</span> 
             <div id="dd3er" runat="server" class="singleHazeLevel singleHazeLevel_Selected" style="margin-right:73%; margin-top: -2px;" onclick="radioClickDateII('dd3er')">8月31日</div>
             <div id="dd4er" runat="server" class="singleHazeLevel singleHazeLevel_UnSelected" style="margin-right:66%; margin-top: -32px;" onclick="radioClickDateII('dd4er')">9月1日</div>
           </div>                                    
               <div id="aqiAreaTableQN" class="tableContent">
                  ...
                  <div  class="aqiContent"><div class="aqiInput"><textarea name="AQI"  rows="2" cols="1"  id="Textarea82"  class="aqiValueII" ></textarea></div></div>
                      ...
                      <div class="editBtns">                                             
                      <div  class="button" onclick="copyFirstPol('3')" style=" display:none;">复制风险等级</div>
                      <div  class="button" onclick="TempSave('青年感冒','dd3er')" style=" display:none;">暂存</div>
               ...
               <div id="aqiAreaTableQNII" class="tableContent" style=" display:none">
                  ...
                  <div  class="aqiContent"><div class="aqiInput"><textarea name="AQI"  rows="2" cols="1"  id="Textarea92"  class="aqiValueII" ></textarea></div></div>
                      ...
                      <div class="editBtns">                                             
                      <div  class="button" onclick="copyFirstPol('4')" style=" display:none;">复制风险等级</div>
                      <div  class="button" onclick="TempSave('青年感冒','dd4er')" style=" display:none;">暂存</div>
    ...
    <div class="totalContentIII" >
        <div class="content" id="Div84" style="float:left;">
           <div class="tablePart">
               <div class="editLabel">
           <div class="titlePoint"></div>
           <span class="partTitle">老年人感冒气象风险预报</span> 
             <div id="dd5er" runat="server" class="singleHazeLevel singleHazeLevel_Selected" style="margin-right:73%; margin-top: -2px;" onclick="radioClickDateIII('dd5er')">8月31日</div>
             <div id="dd6er" runat="server" class="singleHazeLevel singleHazeLevel_UnSelected" style="margin-right:66%; margin-top: -32px;" onclick="radioClickDateIII('dd6er')">9月1日</div>
           </div>                                    
               <div id="aqiAreaTableLR" class="tableContent">
                  ...
                  <div  class="aqiContent"><div class="aqiInput"><textarea name="AQI"  rows="2" cols="1"  id="Textarea103"  class="aqiValueII" ></textarea></div></div>
                      ...
                      <div class="editBtns">                                             
                      <div  class="button" onclick="copyFirstPol('5')" style=" display:none;">复制风险等级</div>
                      <div  class="button" onclick="TempSave('老年感冒','dd5er')" style=" display:none;">暂存</div>
              <%--        <div id="getHistory" class="button">获取历史</div>  
                      <div id="autoCreate" class="button">自动生成</div>    --%>      
           </div>
           </div>
               <div id="aqiAreaTableLRII" class="tableContent" style=" display:none">
                  ...
                  <div  class="aqiContent"><div class="aqiInput"><textarea name="AQI"  rows="2" cols="1"  id="Textarea114"  class="aqiValueII" ></textarea></div></div>
                      ...
                      <div class="editBtns">                                             
                      <div  class="button" onclick="copyFirstPol('6')" style=" display:none;">复制风险等级</div>
                      <div  class="button" onclick="TempSave('老年感冒','dd6er')" style=" display:none;">暂存</div>
     <%--                 <div id="getHistory-ert" class="button">获取历史</div>  
                      <div id="autoCreate-ert" class="button">自动生成</div>   --%>       
           </div>
           </div>        
