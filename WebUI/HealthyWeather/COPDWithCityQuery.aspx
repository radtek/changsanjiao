<%@ Page Language="C#" AutoEventWireup="true" CodeFile="COPDWithCityQuery.aspx.cs" Inherits="COPDWithCityQuery" %>
...
<meta name="renderer" content="webkit">
    ...
    <link href="css/ColdWithCityQuery.css?v=20160412911" rel="stylesheet" type="text/css" />
    ...
    <script src="../JS/Utility.js" type="text/javascript"></script>
    <script src="js/COPDWithCityQuery.js?V=201620310" type="text/javascript"></script>
        ...
        <div class="content" id="rightContent" style="float:left;">
           <div class="tablePart">
               ...
               <div id="aqiAreaTableII-ertong" class="tableContent" style=" display:none">
                  ...
                  <td class="aqiItemTd">  
                     <div  class="aqiContent"><div class="aqiInput"><textarea name="AQI"  rows="2" cols="1" id="Textarea27"  class="aqiValue" ></textarea></div>
                  </td>
                  <td class="aqiValueTd">
