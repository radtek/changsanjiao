<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HighWithCityQuery.aspx.cs" Inherits="HighWithCityQuery" %>
...
<meta name="renderer" content="webkit">
    ...
    <link href="css/ColdWithCityQuery.css?v=20116042119" rel="stylesheet" type="text/css" />
    <link href="../Ext/resources/css/ext-all.css?v=210160429" rel="stylesheet" type="text/css" />
    ...
    <script src="../JS/Utility.js" type="text/javascript"></script>
    <script src="js/HighWithCityQuery.js?V=201603210" type="text/javascript"></script>
        ...
        <div class="content" id="rightContent" style="float:left;">
           <div class="tablePart">
               <div class="editLabelET">
                ...
                <span class="partTitle">重污染健康风险AHI预报</span> 
               ...
               <div id="map" class="mpnew" style="float:right;  left: 0px;">
                 <div class="mapTitleNew">
                  <span>重污染健康风险AHI预报</span><span id="mpContent1" class="export" title="导出这张图片" onclick="cutDiv('重污染健康风险AHI预报','mapDate','pubTime','mps','pubHour')"></span>
                 </div>
