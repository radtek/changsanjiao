...
var oldPeriod = "p10";
var oldDate = "dd1er";
var copdValues = { '1': '无影响', '2': '重症COPD患者', '3': '重症COPD患者', '4': 'COPD患者', '5': 'COPD患者', '6': 'COPD患者' };
...
Ext.onReady(function () {
    ...
    //$("#forecastTime").html(getNowFormatDate()); 2017-03-14 xuehui 
...
function refershChildForecast(flag){
    ...
    Ext.Ajax.request({
        ...
        params: { priod: priod, type: "COPD", forecastTime: forecastTime },
        success: function (response) {
...
function refershChild() {
    ...
    Ext.Ajax.request({
        ...
        params: { priod: priod, type: "COPD", forecastTime: forecastTime, user: user },
        success: function (response) {
            if (response.responseText != "") {
                var vs = response.responseText.split('*');
