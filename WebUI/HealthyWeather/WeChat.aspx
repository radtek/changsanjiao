<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WeChat.aspx.cs" Inherits="HealthyWeather_WeChatEn" %>
    ...
    <div id="page"><%-- <div v-if="val[0].one==1" :class="{grade: true, 'ml': mlIs ,active1:true}"></div>--%>
        ...
        <div style="position:fixed;top:0;left:0;">
            ...
            <div class="bottom" style=" height:15vh;width:100%;float:left;margin-bottom:0;padding: 3vh 8vw;">
                ...
                <div class="level" style="background: rgb(241, 151, 37); font-size: 26px;">medium high</div>
                <div class="level" style="background: rgb(252, 13, 27);">high</div>
            </div>
        </div>
    </div>
    </form>
</body>
    <script src="js/WeChat.js?v=1011111113" type="text/javascript"></script>
</html>
