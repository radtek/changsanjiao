<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HeatstrokeWithCityQuery.aspx.cs" Inherits="HeatstrokeWithCityQuery" %>
...
<meta name="renderer" content="webkit">
    ...
    <link href="css/HeatstrokeWithCity.css?v=20160142191" rel="stylesheet" type="text/css" />
    ...
    <script src="../JS/Utility.js" type="text/javascript"></script>
    <script src="js/HeatstrokeWithCityQuery.js?V=201260310" type="text/javascript"></script>
...
<div class="tableTop">
     ...
     <table style=" width:93%">
           ...
           <input name="H00" type="text" id="H00" runat="server" class="selectDateFormStyle" onchange="DateChange(this)" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="2016-09-08"/></td>
            ...
            <td class="btnTd" style="width:557px;">
        ...
        <div class="content" id="rightContent" style="float:left;">
           <div class="tablePart">
               <div class="editLabelET">
                ...
                <span class="partTitle">中暑气象风险预报</span>
               ...
               <div id="aqiAreaTable" class="tableContent">
                  <table class="aqiAreaTableQuery">
                  <tr>
                      <th scope="col"  style="width:100px;">预报区域</th>
                      <th scope="col" style="width:160px;">风险等级</th>
                      <th scope="col" style="width:200px; display:none">防范人群</th>
                  ...
                  <td class="aqiLevelTd">
                    <div id="58367_FirstPol" class="dateSelect" style=" margin-top:4px;">
                      <div id="selectID" class="dateDiv">
                          <div class="firstPolText" id="58367_Item">不易中暑</div>
                  ...
                  <td class="aqiValueTd" style="display:none;">
                  ...
                  <td class="aqiLevelTd">
                    <div id="58368_FirstPol" class="dateSelect" style=" margin-top:4px;">
                      <div id="selectIDs" class="dateDiv">
                          <div class="firstPolText" id="58368_Item">不易中暑</div>
                  ...
                  <td class="aqiItemTd" style=" display:none">
                  ...
                  <td class="aqiLevelTd">
                    <div id="58369_FirstPol" class="dateSelect" style=" margin-top:4px;">
                      <div id="Div2" class="dateDiv">
                          <div class="firstPolText" id="58369_Item">不易中暑</div>
                  ...
                  <td class="aqiLevelTd"> 
                    <div id="58370_FirstPol" class="dateSelect" style=" margin-top:4px;">
                      <div id="Div3" class="dateDiv">
                          <div class="firstPolText" id="58370_Item">不易中暑</div>
                  ...
                  <td class="aqiLevelTd">
                    <div id="58371_FirstPol" class="dateSelect" style=" margin-top:4px;">
                      <div id="Div5" class="dateDiv">
                          <div class="firstPolText" id="58371_Item">不易中暑</div>
                  ...
                  <td class="aqiLevelTd">
                    <div id="58372_FirstPol" class="dateSelect" style=" margin-top:4px;">
                      <div id="Div7" class="dateDiv">
                          <div class="firstPolText" id="58372_Item">不易中暑</div>
                  ...
                  <td class="aqiLevelTd">
                      ...
                      <div id="Div9" class="dateDiv">
                          <div class="firstPolText" id="58373_Item">不易中暑</div>
                  ...
                  <td class="aqiLevelTd">
                      ...
                      <div id="Div11" class="dateDiv">
                          <div class="firstPolText" id="583734_Item">不易中暑</div>
                  ...
                  <td class="aqiLevelTd">
                      ...
                      <div id="Div12" class="dateDiv">
                          <div class="firstPolText" id="583735_Item">不易中暑</div>
                  ...
                  <td class="aqiLevelTd">
                       <div id="58376_FirstPol" class="dateSelect" style=" margin-top:4px;">
                        <div id="Div13" class="dateDiv">
                          <div class="firstPolText" id="583736_Item">不易中暑</div>
                  ...
                  <div  class="aqiContent"><div class="aqiInput"><textarea name="AQI"  rows="2" cols="1"  id="Textarea8"  class="aqiValueII" ></textarea></div></div>
                      ...
                      <div  class="button" onclick="TempSave('中暑','dd1er')" style=" display:none">暂存</div>
               ...
               <div id="aqiAreaTableII-ertong" class="tableContent" style=" display:none">
                  ...
                  <td class="aqiLevelTd">
                    <div id="Div14" class="dateSelect" style=" margin-top:4px;">
                      <div id="Div20" class="dateDiv">
                          <div class="firstPolText" id="Div21">不易中暑</div>
                  ...
                  <td class="aqiLevelTd">
                    <div id="Div24" class="dateSelect" style=" margin-top:4px;">
                      <div id="Div25" class="dateDiv">
                          <div class="firstPolText" id="Div26">不易中暑</div>
                  ...
                  <td class="aqiLevelTd">
                    <div id="Div29" class="dateSelect" style=" margin-top:4px;">
                      <div id="Div30" class="dateDiv">
                          <div class="firstPolText" id="Div31">不易中暑</div>
                  ...
                  <td class="aqiLevelTd"> 
                    <div id="Div34" class="dateSelect" style=" margin-top:4px;">
                      <div id="Div35" class="dateDiv">
                          <div class="firstPolText" id="Div36">不易中暑</div>
                  ...
                  <td class="aqiLevelTd">
                    <div id="Div39" class="dateSelect" style=" margin-top:4px;">
                      <div id="Div40" class="dateDiv">
                          <div class="firstPolText" id="Div41">不易中暑</div>
                  ...
                  <td class="aqiLevelTd">
                    <div id="Div44" class="dateSelect" style=" margin-top:4px;">
                      <div id="Div45" class="dateDiv">
                          <div class="firstPolText" id="Div46">不易中暑</div>
                  ...
                  <div  class="aqiContent"><div class="aqiInput"><textarea name="AQI"  rows="2" cols="1"  id="Textarea72"  class="aqiValueII" ></textarea></div></div>
                      ...
                      <div  class="button" onclick="TempSave('中暑','dd2er')" style=" display:none">暂存</div>
           </div>
           </div>        
               <div id="map" class="mpnew" style="float:right;  left: 0px;">
                 <div class="mapTitleNew">
                  <span>中暑气象风险预报</span><span id="mpContent1" class="export" title="导出这张图片" onclick="cutDiv('中暑气象风险预报','mapDate','pubTime','mps','pubHour')"></span>
                 </div>
