<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AsthmaWithCityQuery.aspx.cs" Inherits="AsthmaWithCityQuery" %>
...
<meta name="renderer" content="webkit">
    <title></title>
        ...
        <link href="css/ColdWithCityQuery.css?v=20160422191" rel="stylesheet" type="text/css" />
        ...
        <script src="../JS/Utility.js" type="text/javascript"></script>
        <script src="js/AsthmaWithCityQuery.js?V=2201603101" type="text/javascript"></script>
        ...
        <div class="content" id="rightContent" style="float:left;">
           <div class="tablePart">
               <div class="editLabelET">
                ...
                <span class="partTitle">儿童哮喘气象环境风险预报</span> 
               ...
               <div id="map" class="mpnew" style="float:right;  left: 0px;">
                 <div class="mapTitleNew">
                  <span>儿童哮喘气象环境风险预报</span><span id="mpContent1" class="export" title="导出这张图片" onclick="cutDiv('儿童哮喘气象环境风险预报','mapDate','pubTime','mps','pubHour')"></span>
                 </div>
