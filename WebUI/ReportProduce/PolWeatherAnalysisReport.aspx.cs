...
public partial class ReportProduce_PolWeatherAnalysisReport : System.Web.UI.Page
{
    ...
    protected void BtnUpload_Click(object sender, EventArgs e)
    {
        ...
        if (fileOK)
        {
            try
            {
                ...
                {
                    PO_tomHazeImg.Src = "../Temp/" + FileUpload1.FileName;
                }
                if (SelImgID.Value == "PO_aferHazeImg")
                {
                    PO_aferHazeImg.Src = "../Temp/" + FileUpload1.FileName;
                }
                if (SelImgID.Value == "PO_afterHazeImg2")
                {
                    PO_afterHazeImg2.Src = "../Temp/" + FileUpload1.FileName;
                }
                //if(SelImgID.Value=="PO_tomHazeImg")
                //{
