<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AQIPeriod48.aspx.cs" Inherits="ReportProduce_AQIPeriod48" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../AQI/js/OutAQI_48.js?v=20170821111" type="text/javascript"></script>
...
<!--FTP地址集合 -->
<input type="hidden" id="FtpCollection" value="InfoCenterFtp,AQI_SH_YYYYMMDD1700.txt;InfoCenterFtpIII,AQI_SH_YYYYMMDD1700.txt;SciServiceCenter,AQI_SH_YYYYMMDD1700.txt;SciServiceCenterIII,AQI_SH_YYYYMMDD1700.txt;AQILocal,AQI_SH_YYYYMMDD1700.txt;AQILocal62,scuem_air_YYYYMMDD1600.txt;62WebSite,scuem_air_YYYYMMDD1600.txt" />
</body>
</html>
