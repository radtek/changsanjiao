...
<head runat="server">
 ...
 <script language="javascript" type="text/javascript" src="JS/cityForecast.js?v=2017010111"></script>
    ...
    <div class="divTop" >
        <div class="checkStyle">
            ...
            <input id="H00" type="text" class="selectDateFormStyle" runat="server" onchange="DateChange(this)" onclick="WdatePicker({dateFmt:'yyyy年MM月dd日'})"/>
              <input type="button" style="display:none;" id="history" class="button_BottomII"   value=" 获取历史"  onclick="HistoryForecast()"/>
        </div>
    </div>
    <div id="comforecast">
