<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DiagnosticAnalysis.aspx.cs" Inherits="ImgList_DiagnosticAnalysis" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript" src="JS/DiagnosticAnalysis.js"></script>
...
<body id="Body1" runat="server" style="-webkit-overflow-scrolling:touch; overflow: auto;" >
    ...
    <div class="ListContent" id="ListContent">
        ...
        <div id="city" class="dateSelect" style=" margin-top:35px;">
        </div>
