<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TimePollutansDBCityChart.aspx.cs" Inherits="TimePollutansDBCityChart" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>污染物随时间变化-东北</title>
    <link href="css.css" rel="stylesheet" type="text/css" />
    <link type="text/css" rel="stylesheet" href="../Ext/resources/css/ext-all.css"/>
    <script type="text/javascript" src="../Ext/adapter/ext/ext-base.js"></script>
    <script type="text/javascript" src="../Ext/ext-all.js"></script>
    <script type="text/javascript" src="../Ext/ext-lang-zh_CN.js"></script>
    <script language="javascript" type="text/javascript" src="TimePollutansDBCityChart.js?v=20160819"></script>
    ...
    <div id="contentNone">
        ...
        <div class="checkStyle" style=" width:1056px; margin-top:10px; ">
                     <div class="checkLable" style="width:75px">重点城市：</div>
                      <div id="c1" class="radioChecked"><a href="javascript:radioClickModule('c1','齐齐哈尔市','50745');">齐齐哈尔市</a></div>
                      ...
                      <div id="c5" class="radioUnChecked"><a href="javascript:radioClickModule('c5','朝阳市','54324');">朝阳市</a></div>
              ...
              <table align="center" cellpadding="0" cellspacing="0" class="hct">
                ...
                <tr>
                   ...
                   <tr>
                    ...
                    <tr>
                    <td>
                       <div id="container5" style="width: 1050px; height:350px; margin: 0 0 0 0 0;"></div></td>
                </tr>
                    <tr>
                    <td>
                       <div id="container6" style="width: 1050px; height:350px; margin: 0 0 0 0 0;"></div></td>
                </tr>
            </table>
