...
namespace Readearth.Data.Entity
{
    ...
    public class Entity
    {
        ...
        //private void BuildRealValueOther(PropertyOV fieldValue, PropertyOV fieldValue1)
        //{
        //    string strSQL;
        ...
        //        {
        //            if (fieldValue1.Value != null || fieldValue1.Value != "")
        //            {
        //                strSQL = "SELECT DM FROM " + fieldValue1.DictName + " WHERE MC = '" + fieldValue1.ShowValue + "'";
        //                string type = m_Database.GetFirstValue(strSQL);
        //                if (type != "" && type != null)
        //                {
        //                    Entity entity = new Entity(m_Database, fieldValue1.EntityName);
        //                    string strWhere = "SELECT MAX(FORECASTDATE) FROM " + entity.TableName + " WHERE Layers='" + type + "'";
        //                    if (entity.Condition != "")
        //                    {
        //                        strWhere = strWhere + " AND  " + entity.Condition;
        //                    }
        //                    string forecast = m_Database.GetFirstValue(strWhere);
        //                    fieldValue.ShowValue = forecast;
        //                }
        //            }
