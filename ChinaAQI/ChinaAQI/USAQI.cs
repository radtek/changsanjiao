...
namespace Lucas.USAQI1997
{
    ...
    public class USAQI1997 : IConvertAQI
    {
        ...
        private readonly double[] rPM25Lo24Hr = { 0.00, 15.5, 35.5, 65.5, 150.5, 250.5, 350.5, 500.5 };
        private readonly double[] rPM25Hi24Hr = { 15.4, 35.4, 65.4, 150.4, 250.4, 350.4, 500.4, 999.0 };
        ...
        private readonly double[] rAPILo = { 0.0, 51.0, 101.0, 151.0, 201.0, 301.0, 401.0, 500.0 };
