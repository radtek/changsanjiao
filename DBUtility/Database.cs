...
namespace Readearth.Data
{
    ...
    public class Database
    {
        ...
        /// <returns></returns>
        public  int ExecuteNonQuery(string connectionString, CommandType cmdType, string cmdText, int commandTimeout, params SqlParameter[] commandParameters)
        {
        ...
        public SqlDataReader GetDataReader(string queryString, params SqlParameter[] values)
        {
            ...
            try
            {
                ...
                SqlCommand dbCommand = new SqlCommand(queryString, connection);
                connection.Open();
                if (queryString.ToLower().IndexOf("select") >= 0 && queryString.ToLower().IndexOf("from") >= 0)
                {
        ...
        public int ExecuteMySQL(string editSQL)
        {
        ...
        public DataTable GetDataTableMySQL(string queryString)
        {
            using (MySqlConnection connection = new MySqlConnection(m_ConnectionString))
            {
